# TITLE:	make_gene_set_files_v33.R
...
# INPUT:    human_gene_reference_path: Reference file for human genes (hg19) version 33, including chromosomes, gene names and gene IDs.
...
geneset_out_path = '/hpc/hers_en/molislagers/LDSC/celltype_enrichment/KI_level1/geneset_v33'
...
########## Load KI data ########## 
data(ctd_allKI)
mean_expr_data <- ctd_allKI[[1]]$mean_exp
specificity <- ctd_allKI[[1]]$specificity
